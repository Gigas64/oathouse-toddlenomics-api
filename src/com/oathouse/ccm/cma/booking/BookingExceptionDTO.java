...
/**
 * The {@code BookingExceptionDTO} Class represents a bookings that produced an exception
 ...
 */
public class BookingExceptionDTO {
    ...
    public BookingExceptionDTO(int ywd, int bookingId, int childId, int preBookingTypeId, int preBookingSd,
