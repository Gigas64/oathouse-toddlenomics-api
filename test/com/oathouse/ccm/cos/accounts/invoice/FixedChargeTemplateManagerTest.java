 ...
 */
public class FixedChargeTemplateManagerTest {

    private String owner;
    private FixedChargeTemplateManager manager;

    public FixedChargeTemplateManagerTest() {
        owner = "tester";
    }

    @Before
    public void setUp() throws Exception {
        manager = new FixedChargeTemplateManager("FixedChargeTemplateManager");
        manager.init();
