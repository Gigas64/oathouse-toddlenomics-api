 ...
 */
public class InvoiceLineTransformerTest_getFixedItemChildDto {
    @Before
    public void setUp() {
    ...
    public void runThrough() throws Exception {
        ...
        List<InvoiceLineDTO> result = InvoiceLineTransformer.getFixedItemDto(-1, account, child, billingMap);
